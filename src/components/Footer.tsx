import { Github, Linkedin, Mail, Heart, Facebook, Instagram, BadgeIcon, BoldIcon } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/Biswajit8280"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/biswajit-biswal-06a4712b6/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-background/10 rounded-lg flex items-center justify-center hover:bg-background/20 transition-colors duration-200 group"
              ...
              <a
                href="https://www.facebook.com/share/1BHWAXvpnQ/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-background/10 rounded-lg flex items-center justify-center hover:bg-background/20 transition-colors duration-200 group"
              ...
              <a
                href="https://www.instagram.com/biswajit__143__kishan__?igsh=YWhwenQyd2l0YnNl"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-background/10 rounded-lg flex items-center justify-center hover:bg-background/20 transition-colors duration-200 group"
        ...
        <div className="border-t border-background/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-2 text-background/80">
              <span>Made By</span>
              <BoldIcon size={16} className="text-blue-500 animate-pulse" />
